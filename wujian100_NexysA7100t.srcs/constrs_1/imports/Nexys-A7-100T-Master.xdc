...
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 }  [get_ports POUT_EHS]
#===========================================
# C-SKY  JTAG interface: JA1
#===========================================
set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 }  [get_ports PAD_JTAG_TCLK]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets PAD_JTAG_TCLK]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 }  [get_ports PAD_JTAG_TMS]
...
##CPU Reset Button
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { PAD_MCURST }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
